  ...
  return (
    <div className="p-6 md:p-8 max-w-[900px] mx-auto space-y-8">
      ...
      <SettingsSection 
        ...
        title="Integrations"
        description="Connect your CRM, call recorder, and notification channels"
      >
        <div className="space-y-3">
          ...
          <IntegrationRow 
            name="Salesforce" 
            description="Import opportunities and account intelligence" 
            connected={false} 
          />
          <IntegrationRow 
            name="Gong / Chorus" 
            description="Auto-import call transcripts for analysis" 
            connected={false} 
          />
          <IntegrationRow 
            name="Slack" 
            description="Receive real-time alerts and Sentinel notifications" 
            connected={false} 
          />
          <IntegrationRow 
            name="Google Meet / Zoom" 
            description="Live meeting sidekick and transcript capture" 
            connected={false} 
          />
        </div>
      </SettingsSection>
      ...
      <SettingsSection
        ...
        title="Slack Alert Configuration"
        description="Route different alert types to specific Slack channels"
      >
        <div className="space-y-4">
      ...
      <SettingsSection 
        ...
        description="Manage API keys for the Oakwell engine"
      >
        <div className="space-y-4">
      ...
      <SettingsSection 
        ...
        description="Configure the autonomous market monitoring agent"
      >
        <div className="space-y-4">
